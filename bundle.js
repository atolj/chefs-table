...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ingredientsIngredientSectionJsx = __webpack_require__(160);

	var _ingredientsIngredientSectionJsx2 = _interopRequireDefault(_ingredientsIngredientSectionJsx);

	var _instructionsInstructionSectionJsx = __webpack_require__(164);

	var _instructionsInstructionSectionJsx2 = _interopRequireDefault(_instructionsInstructionSectionJsx);
	...
	var App = (function (_Component) {
	    ...
	    _createClass(App, [{
	        key: 'addIngredient',
	        value: function addIngredient(name) {
	            var ingredients = this.state.ingredients;

	            ingredients.push({ id: ingredients.length, name: name });
	            this.setState({ ingredients: ingredients });
	            // TODO: Send to server
	        }
	    }, {
	        key: 'setIngredient',
	        value: function setIngredient(activeIngredient) {
	            this.setState({ activeIngredient: activeIngredient });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _IngredientFormJsx = __webpack_require__(161);

	var _IngredientFormJsx2 = _interopRequireDefault(_IngredientFormJsx);

	var _IngredientListJsx = __webpack_require__(162);

	var _IngredientListJsx2 = _interopRequireDefault(_IngredientListJsx);

	var IngredientSection = (function (_Component) {
	    _inherits(IngredientSection, _Component);

	    function IngredientSection() {
	        _classCallCheck(this, IngredientSection);

	        _get(Object.getPrototypeOf(IngredientSection.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(IngredientSection, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'panel-body ingredients' },
	                    _react2['default'].createElement(_IngredientListJsx2['default'], this.props),
	                    _react2['default'].createElement(_IngredientFormJsx2['default'], this.props)
	                )
	            );
	        }
	    }]);
	...
	IngredientSection.propTypes = {
	    ...
	    setIngredient: _react2['default'].PropTypes.func.isRequired,
	    addIngredient: _react2['default'].PropTypes.func.isRequired,
	    activeIngredient: _react2['default'].PropTypes.object.isRequired
	};

	exports['default'] = IngredientSection;
	module.exports = exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IngredientForm = (function (_Component) {
	    _inherits(IngredientForm, _Component);

	    function IngredientForm() {
	        _classCallCheck(this, IngredientForm);

	        _get(Object.getPrototypeOf(IngredientForm.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(IngredientForm, [{
	        ...
	        value: function onSubmit(e) {
	            e.preventDefault();
	            var node = this.refs.ingredient;
	            var ingredientName = node.value;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _IngredientJsx = __webpack_require__(163);

	var _IngredientJsx2 = _interopRequireDefault(_IngredientJsx);

	var IngredientList = (function (_Component) {
	    _inherits(IngredientList, _Component);

	    function IngredientList() {
	        _classCallCheck(this, IngredientList);

	        _get(Object.getPrototypeOf(IngredientList.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(IngredientList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'ul',
	                null,
	                this.props.ingredients.map(function (ingred) {
	                    return _react2['default'].createElement(_IngredientJsx2['default'], _extends({
	                        ingredient: ingred,
	                        key: ingred.id
	                    }, _this.props));
	                })
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Ingredient = (function (_Component) {
	    ...
	    function Ingredient() {
	        ...
	        _get(Object.getPrototypeOf(Ingredient.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(Ingredient, [{
	        ...
	        value: function onClick(e) {
	            ...
	            var setIngredient = _props.setIngredient;
	        ...
	        value: function render() {
	            ...
	            var ingredient = _props2.ingredient;
	            var activeIngredient = _props2.activeIngredient;

	            var active = ingredient === activeIngredient ? 'active' : '';
	            return _react2['default'].createElement(
	                'li',
	                { className: active },
	                _react2['default'].createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _InstructionListJsx = __webpack_require__(165);

	var _InstructionListJsx2 = _interopRequireDefault(_InstructionListJsx);

	var InstructionSection = (function (_Component) {
	    _inherits(InstructionSection, _Component);

	    function InstructionSection() {
	        _classCallCheck(this, InstructionSection);

	        _get(Object.getPrototypeOf(InstructionSection.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(InstructionSection, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _InstructionJsx = __webpack_require__(166);

	var _InstructionJsx2 = _interopRequireDefault(_InstructionJsx);

	var InstructionList = (function (_Component) {
	    _inherits(InstructionList, _Component);

	    function InstructionList() {
	        _classCallCheck(this, InstructionList);

	        _get(Object.getPrototypeOf(InstructionList.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(InstructionList, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Instruction = (function (_Component) {
	    ...
	    function Instruction(props) {
	        ...
	        _get(Object.getPrototypeOf(Instruction.prototype), "constructor", this).call(this, props);
